      ...
      *| DATE GENERATED: 12/18/2020 15:12                              |
      *| ID: 2b943d80-0dce-4b09-b9ea-effa0b62e771                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| TEST_TEST2                                                    |
      ...
      *+---------------------------------------------------------------+
       ...
       01 PROGRAM-NAME   PIC X(8)  VALUE 'LGACDB01'.
       01 BZ-ASSERT.
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          3 ZUT00000000.
            5 PIC X(6) DISPLAY VALUE '01ACUS'.
          3 ZUT00000001.
          ...
          3 ZUT00000004.
            5 PIC X(10) DISPLAY VALUE 'MINHA CASA'.
            5 PIC X(10) DISPLAY VALUE SPACES.
          3 ZUT00000005.
            5 PIC X(4) DISPLAY VALUE '4429'.
          3 ZUT00000006.
            5 PIC X(5) DISPLAY VALUE '33722'.
            5 PIC X(3) DISPLAY VALUE SPACES.
          3 ZUT00000007.
            5 PIC X(12) DISPLAY VALUE '781-522-1900'.
            5 PIC X(8) DISPLAY VALUE SPACES.
          3 ZUT00000008.
            5 PIC X(12) DISPLAY VALUE '617-515-8978'.
            5 PIC X(8) DISPLAY VALUE SPACES.
          3 ZUT00000009.
            5 PIC X(13) DISPLAY VALUE 'regi@mail.com'.
            5 PIC X(87) DISPLAY VALUE SPACES.
          3 ZUT0000000A.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           IF (CA-CUSTOMER-NUM OF DFHCOMMAREA IS NUMERIC)
               AND (CA-CUSTOMER-NUM OF DFHCOMMAREA = 1000002) THEN
             CONTINUE
           ELSE
             MOVE CA-CUSTOMER-NUM OF DFHCOMMAREA TO ZUT00000010(1)
             MOVE 1000002 TO ZUT00000010(2)
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE '2b943d80-0dce-4b09-b9ea-effa0b62e771'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION USING TC-WORK-AREA AZ-GRP-INDEX AZ-FLAG-IN
           ...
           IF DATA-PTR-VALUE = 0 THEN
             COMPUTE DATA-SIZE = LENGTH OF WK-RECORD-COUNT * 2 * 10
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION.
      * CHECK OUTPUT VALUE
      * CICS_INPT_0E08_LGACDB01.
           ENTRY 'CICS_INPT_0E08_LGACDB01' USING AZ-TEST
           AZ-INFO-BLOCK AZ-DFHEIBLK AZ-DFHCOMMAREA ARG0 ARG1 ARG2
           ARG3 ARG4 ARG5 ARG6 ARG7 ARG8 ARG9 ARG10.
           DISPLAY 'CICS_0E08_LGACDB01 CHECK VALUES...'
           MOVE 4 TO RETURN-CODE.
      ...
      * EXEC CICS RETURN X'0000'
           ...
           PERFORM TEARDOWN.
      * SET INPUT VALUE
      * CICS_OUTP_0E08_LGACDB01.
           ENTRY 'CICS_OUTP_0E08_LGACDB01' USING AZ-TEST
           AZ-INFO-BLOCK AZ-DFHEIBLK AZ-DFHCOMMAREA ARG0 ARG1 ARG2
           ARG3 ARG4 ARG5 ARG6 ARG7 ARG8 ARG9 ARG10.
           DISPLAY 'CICS_0E08_LGACDB01 INPUT VALUES...'
           MOVE 0 TO RETURN-CODE.
           MOVE 0 TO AZ-TEST-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      ...
      * EXEC CICS RETURN X'0000'
       ...
       GETLINENUM.
           ...
           EXIT.
       TEARDOWN.
           DISPLAY 'CICS_0E08_LGACDB01 SUCCESSFUL.'
           GOBACK.
       END PROGRAM 'CICS_0E08_LGACDB01'.
