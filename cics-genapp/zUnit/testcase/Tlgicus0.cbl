      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE '4f15eed0-f15b-4f39-8561-7d6690a8882d'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION.
      * CHECK OUTPUT VALUE
      * CICS_INPT_0E08_LGICUS01.
           ENTRY 'CICS_INPT_0E08_LGICUS01' USING AZ-TEST
           AZ-INFO-BLOCK AZ-DFHEIBLK AZ-DFHCOMMAREA ARG0 ARG1 ARG2
           ARG3 ARG4 ARG5 ARG6 ARG7 ARG8 ARG9 ARG10.
           DISPLAY 'CICS_0E08_LGICUS01 CHECK VALUES...'
           MOVE 4 TO RETURN-CODE.
      ...
      * EXEC CICS RETURN X'0000'
           ...
           PERFORM TEARDOWN.
      * SET INPUT VALUE
      * CICS_OUTP_0E08_LGICUS01.
           ENTRY 'CICS_OUTP_0E08_LGICUS01' USING AZ-TEST
           AZ-INFO-BLOCK AZ-DFHEIBLK AZ-DFHCOMMAREA ARG0 ARG1 ARG2
           ARG3 ARG4 ARG5 ARG6 ARG7 ARG8 ARG9 ARG10.
           DISPLAY 'CICS_0E08_LGICUS01 INPUT VALUES...'
           MOVE 0 TO RETURN-CODE.
           MOVE 0 TO AZ-TEST-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      ...
      * EXEC CICS RETURN X'0000'
       ...
       GETLINENUM.
           ...
           EXIT.
       TEARDOWN.
           DISPLAY 'CICS_0E08_LGICUS01 SUCCESSFUL.'
           GOBACK.
       END PROGRAM 'CICS_0E08_LGICUS01'.
